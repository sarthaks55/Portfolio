    ...
    return (
        <div className="someProjectsContainer">
            <div className="videoSection">
                <h4>Some Projects</h4>
                <p>To see More <Link className="viewMore" to='/proyectos' onClick={() => window.scrollTo(0, 0)}>click here</Link> </p>
            </div>
            <div className="videoDescrip">
                <video className="proyectVideo" src='/assets/video.mp4' autoPlay loop muted/>
